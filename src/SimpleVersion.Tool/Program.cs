...
#pragma warning restore CA1031 // Do not catch general exception types
        ...
        private static IVersionCalculator ResolveCalculator(string path)
        {
            var services = new ServiceCollection()
                ...
                // TODO - discovery
                .AddSingleton<ITokenRequestHandler<BranchNameTokenRequest>, BranchNameToken>()
                .AddTransient<ITokenRequestHandler<ShortBranchNameTokenRequest>>(sp => sp.GetRequiredService<ITokenRequestHandler<BranchNameTokenRequest>>())
                .AddSingleton<ITokenRequestHandler<LabelTokenRequest>, LabelToken>()
                .AddSingleton<ITokenRequestHandler<SemverTokenRequest>, SemverToken>()
                .AddSingleton<ITokenRequestHandler<ShaTokenRequest>, ShaToken>()
                .AddSingleton<ITokenRequestHandler<ShortShaTokenRequest>>(sp => sp.GetRequiredService<ITokenRequestHandler<ShaTokenRequest>>())
                .AddSingleton<ITokenRequestHandler<VersionTokenRequest>, VersionToken>()
                .AddSingleton<ITokenRequestHandler<MetadataTokenRequest>, MetadataToken>()
                .AddSingleton<ITokenRequestHandler<HeightTokenRequest>, HeightToken>()
