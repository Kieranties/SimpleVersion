...
#pragma warning restore CA1031 // Do not catch general exception types
        ...
        private static IVersionCalculator ResolveCalculator(string path)
        {
            var services = new ServiceCollection()
                ...
                .AddSingleton<IToken, BranchNameToken>()
                .AddSingleton<IToken, LabelToken>()
                .AddSingleton<IToken, SemverToken>()
                .AddSingleton<IToken, ShaToken>()
                .AddSingleton<IToken, ShortBranchNameToken>()
                .AddSingleton<IToken, VersionToken>()
                .AddSingleton<IToken, MetadataToken>()
                .AddSingleton<IToken, ShortShaToken>()
                .AddSingleton<IToken, HeightToken>()
